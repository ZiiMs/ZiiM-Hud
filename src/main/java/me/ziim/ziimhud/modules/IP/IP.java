package me.ziim.ziimhud.modules.IP;
...
public class IP extends AbstractWidget {
    public static final Identifier ID = new Identifier("ziimhud", "ip");
    ...
    public Storage getStorage() {
        return Ziimhud.storage.ipStorage;
    }
