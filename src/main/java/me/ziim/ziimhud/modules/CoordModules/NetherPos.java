...
public class NetherPos extends AbstractWidget {
    private final Identifier ID = new Identifier("ziimhud", "netherpos");
    ...
    public LiteralText getData() {
        ...
        if (client.player != null) {
            data =  new LiteralText(String.format("%s", getNetherCoords(client.player)));
        } else {
    ...
    public LiteralText getText() {
        LiteralText text = new LiteralText("Nether Pos: ");
    ...
    public Storage getStorage() {
        return Ziimhud.storage.netherPosStorage;
    }

    private String getNetherCoords(ClientPlayerEntity player) {
