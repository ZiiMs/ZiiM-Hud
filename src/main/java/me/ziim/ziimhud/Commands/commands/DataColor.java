...
public class DataColor extends Command {

    public DataColor() {
        super("datacolor", "Changes color of text");
    }
                        ...
                        .then(argument("g", IntegerArgumentType.integer())
                                .then(argument("b", IntegerArgumentType.integer())
                                        .executes(context -> {
                                            ...
                                            widget.setDataColor(new ColorHelper(r,g,b));
                                            mc.inGameHud.getChatHud().addMessage(new LiteralText(widget.getData().asString() + " color changed to: ").append(new LiteralText(r + " " + g + " " + b).styled(style -> style.withColor(net.minecraft.text.TextColor.fromRgb(new ColorHelper(r,g,b).getPacked())))));
                                            return SINGLE_SUCCESS;
                                        })))));
    }
}
