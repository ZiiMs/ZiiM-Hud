                        ...
                        .then(argument("g", IntegerArgumentType.integer())
                                .then(argument("b", IntegerArgumentType.integer())
                                        .executes(context -> {
                                            ...
                                            mc.inGameHud.getChatHud().addMessage(Text.literal(widget.getData().asString() + " color changed to: ").append(Text.literal(r + " " + g + " " + b).styled(style -> style.withColor(net.minecraft.text.TextColor.fromRgb(new ColorHelper(r,g,b).getPacked())))));
                                            return SINGLE_SUCCESS;
                                        })))));
    }
}
